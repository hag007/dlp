...
def main(model,use_z, fraction, epoch_checkpoint=300, suffix=""):
    ...
    dataset_names=[a for i, a in enumerate(constants.NEW_DATASETS_NAMES) if constants.NEW_DATASETS_INCLUDED[i]]
    ...
    with torch.no_grad():
        ...
        colormap = cm.terrain
        patches_new=plot(encoder, testloader, device, suffix + "_new", path_format_to_save.format(epoch_checkpoint), constants.NEW_DATASETS_NAMES, colormap, 'blue')
...
if __name__=="__main__":
    ...
    epoch_checkpoints=[600] # [50, 100, 150,200,250,300]
    suffix=""
