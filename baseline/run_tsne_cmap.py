...
def main():
    print("start script...")
    dataset_names_tcga=constants_cmap.ALL_DATASET_NAMES
    dataset= datasets.Dataset(dataset_names=dataset_names_tcga, data_type=constants_cmap.DATA_TYPE)
    ...
    plt.savefig(os.path.join(constants_cmap.OUTPUT_GLOBAL_DIR, "clustering_tnse_cmap_knn.png"))
