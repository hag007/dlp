...
import  constants_cmap as constants
...
def main():
    ...
    dataset= datasets.Dataset(dataset_names=dataset_names_original, data_type=constants.DATA_TYPE)
    ...
    plt.savefig(os.path.join(constants.OUTPUT_GLOBAL_DIR, "pca_cmap_new_labels.png"))
